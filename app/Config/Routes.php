...
$routes->get('index-rtl-dark', 'Home::show_index_rtl_dark');
...
$routes->get('layouts-horizontal-rtl-dark', 'Home::show_layouts_horizontal_rtl_dark');
...
$routes->get('apps-blog-grid', 'Home::show_blog_grid');
$routes->get('apps-blog-list', 'Home::show_blog_list');
$routes->get('apps-blog-detail', 'Home::show_blog_detail');
// Pages
...
$routes->get('auth-logout', 'Home::show_auth_logout');
...
$routes->match(['get', 'post'], 'form-uploads', 'Home::show_form_uploads');
