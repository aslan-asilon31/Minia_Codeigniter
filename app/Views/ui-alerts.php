                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="card-title-desc">Add <code>.alert-top-border</code> class with for top alerts.</p>
                            </div><!-- end card header-->
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="card-title-desc">Alert label add <code>.alert-heading</code> class with additional content example</p>
                            </div><!-- end card header-->
