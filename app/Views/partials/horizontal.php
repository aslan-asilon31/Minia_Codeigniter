            ...
            <div class="dropdown d-inline-block">
                ...
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="assets/images/users/avatar-1.jpg"
                        alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1 fw-medium"><?= lang('Files.Shawn L') ?>.</span>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-uielement" role="button">
                            ...
                            <span data-key="t-elements"><?= lang('Files.Elements') ?></span> 
                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="col-lg-5">
                                                    <div>
                                                        ...
                                                        <a href="ui-placeholders" class="dropdown-item" data-key="t-progress-bars"><?= lang('Files.Placeholders') ?></a>
                                                        ...
                                                        <a href="ui-toasts" class="dropdown-item" data-key="t-toasts"><?= lang('Files.Toasts') ?></a>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                            ...
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle d-flex justify-content-between align-items-center" href="#" id="topnav-contact"
                                    role="button">
                                    <span data-key="t-contacts" class=""><?= lang('Files.Blog') ?></span> 
                                    <span class="badge bg-danger-subtle text-danger"><?= lang('Files.New') ?></span>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-contact">
                                    <a href="apps-blog-grid" class="dropdown-item" data-key="t-blog-grid"><?= lang('Files.Blog_Grid') ?></a>
                                    <a href="apps-blog-list" class="dropdown-item" data-key="t-blog-list"><?= lang('Files.Blog_List') ?></a>
                                    <a href="apps-blog-detail" class="dropdown-item" data-key="t-blog-details"><?= lang('Files.Blog_Details') ?></a>
                                </div>
                            </div>
                        </div>
                    </li>
