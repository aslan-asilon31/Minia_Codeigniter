            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li>
                            <a href="javascript: void(0);" class="">
                                <span data-key="t-blog"><?= lang('Files.Blog') ?></span>
                                <span class="badge rounded-pill badge-soft-danger float-end" key="t-new"><?= lang('Files.New') ?></span>
                            </a>
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="apps-blog-grid" data-key="t-blog-grid"><?= lang('Files.Blog_Grid') ?></a></li>
                                <li><a href="apps-blog-list" data-key="t-blog-list"><?= lang('Files.Blog_List') ?></a></li>
                                <li><a href="apps-blog-detail" data-key="t-blog-details"><?= lang('Files.Blog_Details') ?></a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="ui-placeholders" data-key="t-progress-bars"><?= lang('Files.Placeholders') ?></a></li>
                        ...
                        <li><a href="ui-toasts" data-key="t-typography"><?= lang('Files.Toasts') ?></a></li>
