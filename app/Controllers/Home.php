...
class Home extends BaseController
{
	...
	public function show_index_rtl_dark()
	{
		...
		return view('index-rtl-dark', $data);
	}
	...
	public function show_blog_grid(){
		$data = [
			'title_meta' => view('partials/title-meta', ['title' => 'Blog_Grid']),
			'page_title' => view('partials/page-title', ['title' => 'Blog_Grid', 'li_1' => 'Blog' , 'li_2' => 'Blog Grid'])
		];
		return view('apps-blog-grid', $data);
	}

	public function show_blog_list(){
		$data = [
			'title_meta' => view('partials/title-meta', ['title' => 'Blog_List']),
			'page_title' => view('partials/page-title', ['title' => 'Blog_List', 'li_1' => 'Blog' , 'li_2' => 'Blog List'])
		];
		return view('apps-blog-list', $data);
	}

	public function show_blog_detail(){
		$data = [
			'title_meta' => view('partials/title-meta', ['title' => 'Blog_Details']),
			'page_title' => view('partials/page-title', ['title' => 'Blog_Details', 'li_1' => 'Blog' , 'li_2' => 'Blog Detail'])
		];
		return view('apps-blog-detail', $data);
	}
	...
	public function show_layouts_horizontal_rtl_dark()
	{
		$data = [
			'title_meta' => view('partials/title-meta', ['title' => 'Horizontal']),
			'page_title' => view('partials/page-title', ['title' => 'Horizontal', 'li_1' => 'Layouts', 'li_2' => 'Horizontal'])
		];
		return view('layouts-horizontal-rtl-dark', $data);
	}
	...
	public function show_auth_logout()
	{
		$data = [
	...
	public function show_ui_placeholders()
	{
		$data = [
			...
			'page_title' => view('partials/page-title', ['title' => 'Placeholders', 'li_1' => 'Components', 'li_2' => 'Placeholders'])
		];
	...
	public function show_ui_toasts()
	{
		$data = [
			...
			'page_title' => view('partials/page-title', ['title' => 'Toasts', 'li_1' => 'Components', 'li_2' => 'Toasts'])
		];
